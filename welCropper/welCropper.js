...
var init = function (W, H) {
    ...
    that.showCropper = (options) => {
        ...
        console.log(that.data.cropperData.cropCallback)
        console.log('callback---------------------')
        ...
        if (src) {
            wx.getImageInfo({
                ...
                success: function (res) {
                    ...
                    console.log("刚载入时获取图片信息");
                    console.log(res);
                    console.log(w);
                    console.log(h);
                    console.log(that.data.cropperData.height)
                    console.log("载入时获取信息结束");
